                        ...
                        <div class="logo_side">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="email" name="email" id="readEmail" class="form-control correct-email" value="jessicarob@staffviz.com" readonly>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="company-name" name="company-name" placeholder="CrecenTech Systems" class="form-control">
                ...
                <div class="row gap">
                    ...
                    <div class="col-md-5 img_side">
                        ...
                        <div class="d-flex icon_box boxes">
                            ...
                            <img class="sidebar-tick" src="{{ asset('public/assets/img/sidebar-gray-tick.png') }}" alt="Sidebar">
                        </div>
                        <div class="d-flex icon_box">
                            <div>
                                <div class="icon icon-sm icon-secondary">
                    ...
                    <div class="col-lg-7">
                        <div class="logo_side">
                            ...
                            <div class="mb-3 form-check">
                                ...
                                <label class="form-check-label" for="privacyCheck">I Agree To The <a href="{{url('privacy-policy')}}">Privacy Policy</a>  </label>
                        ...
                        <div class="logo_side">
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label for="cardHolderName" class="form-label">Card Holder Name<span>*</span></label>
                                    <input type="text" name="cardHolderName" placeholder="Jack Sparrow" class="form-control cardHolderName" id="cardHolderName">
                                    <span id="cardHolderName-error" class="form-error hide"></span>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="cardNumber" class="form-label">Card Number<span>*</span></label>
                                    <input type="text" placeholder="1234 1234 5678 0000" class="form-control cardNumber" id="cardNumber" name="cardNumber">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" placeholder="02/23" class="form-control validThrough" id="validThrough" name="validThrough">
