            ...
            <div class="col-xl-6 col-lg-6 col-md-6">
                <form action="" id="contactUsForm">
                    <div class="row position-relative">
                        ...
                        <div class="col-md-12">
                            <div class="md-form">
                                <textarea type="text" id="message" name="message" placeholder="Message" rows="3"
                        ...
                        <div class="col-md-12">
                            <div class="md-form">
                                <label class="opt_in_text">
                                    <input type="checkbox" name="opt_in" id="opt_in">
                                    By checking this box, you give your express consent to receive recurring updates and insights about Staffviz via email, phone, and SMS messages from Staffviz, even if you're on a State or Federal Do-Not-Call list. This program includes information about our products, offers, and promotions. We will send messages at a frequency of regularly recurring messages, up to a maximum of 5 per month. Your privacy is paramount to us. We won't share your details with any third parties. By providing your details, you acknowledge and agree to our <a href="https://www.staffviz.com/terms-conditions">Terms of Use</a> and <a href="https://www.staffviz.com/privacy-policy">Privacy Policy</a>. Please note that consent to receive messages is not a condition for any purchase. Standard message & data rates may apply. You can opt out at any time by replying with the keyword "STOP". For additional assistance or information, reply with "HELP" or contact our customer care at <a href="tel: (855) 855-3140">(855) 855-3140</a>.
                                </label>
                            </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" id="contact_us_staff_vizz" class="get_btn">submit</button>
                    </div>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0 text-center">
                <div class="card h-100 p-1 p-md-4">
                    <div class="card-body">
                        <div class=" mb-4">
                ...
                <div class="card h-100 p-1 p-md-4">
                    <div class="card-body">
                        ...
                        <p>Send us an email, and we we'll<br> respond promptly to your inquiries<br>
                            <a class="num_color" href="mailto:support@staffviz.com" style="text-decoration:underline;">
                                support@staffviz.com
                            </a>
                        </p>
                    </div>
                </div>
