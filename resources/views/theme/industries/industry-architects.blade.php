    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Redefine How<br> Architects Work,<br> Plan, and Create </h1>
                <div class="col-xl-8 col-md-9 hero-text">
                    
                    <p>Boost your architectural team's productivity with StaffViz. Manage your team, projects, and timelines effortlessly—all in one smart platform designed for architects who value precision and creativity.</p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/architechts.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Blueprint Your Success with StaffViz</h2>
                        <h6>Turn Complex Projects into Seamless Workflows</h6>
                        <div class="pb-4">
                            <p>From concept to construction, StaffViz simplifies every step of your architectural projects.</p>
                            <ul>
                            <li>Assign tasks and align your team with project goals.</li>
                                <li>Monitor deadlines and milestones to keep projects on track.</li>
                                <li>Coordinate resources across multiple phases with precision.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="hero-btns">
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/074898.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="scalable-infra freelance">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/074887.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Tools Built for Architects</h2>
                        <h3>Master Your Time, Optimize Your Performance</h3>
                        <div class="pb-4">
                            <p>StaffViz brings order to creative chaos, ensuring every hour counts.
                            </p>
                            <ul>
                                <li>Build schedules that reflect design reviews, site visits, and deadlines.</li>
                                <li>Track time spent on sketches, modeling, and client consultations.</li>
                                <li>Analyze team productivity to refine your workflows and deliver exceptional results.</li>
                            </ul>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Bridge Creativity and Efficiency</h2>
                        <h3>
                        Integrate with the Tools You Trust
                        </h3>
                        <div class="pb-4">
                            <p>Seamlessly connect StaffViz with your go-to platforms through Zapier like AutoCAD, Revit, or Asana to streamline your workflow. </p>
                            <ul>
                                <li>Sync project updates without the hassle of switching between tools.</li>
                                <li>Automate repetitive tasks to focus on what matters—your designs.</li>
                            </ul>
                        </div>
                        </div>
                    <div class="hero-btns">
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/07489.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="innovative-iteg freelance">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/7490546.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>RBAC to Protect Your Ideas and Designs</h2>
                        <h3>
                        Security You Can Build On
                        </h3>
                        <div class="pb-4">
                            <p>Architectural projects require discretion, and StaffViz provides:</p>
                            <ul>
                            <li>Role-based access to keep sensitive designs secure..</li>
                                <li> Permissions to abstract intellectual property and client data.</li>
                                
                                <li>Comprehensive activity logs to ensure accountability and compliance.</li>
                            </ul>
                        </div>
                     </div>
                    <div class="hero-btns">
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Architects Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
