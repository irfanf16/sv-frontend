    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Propel Your <br>Merchandising Operations<br> with StaffViz</h1>
                <div class="col-xl-8 col-md-9 hero-text">

                    <p>StaffViz is designed to revolutionize workforce coordination, enhance team efficiency, and ensure flawless execution in your merchandising business.</p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/merchandise.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Streamline Processes and Enhance Retail Execution</h2>
                        <h6>Efficient Workforce and Task Management</h6>
                        <p>Effectively assign tasks and oversee responsibilities across your merchandising teams. Align every team member with operational goals using StaffViz’s task allocation features. Whether managing product placements, stock organization, or promotional setups, StaffViz ensures every detail is handled with precision.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/17074899.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="scalable-infra">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/17074866.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Adapt Staff Schedules for High-Volume Periods</h2>
                        <h3>Comprehensive Time and Shift Management</h3>
                        <p>Develop and assign shifts, monitor attendance patterns, and track downtime to maintain optimal staffing levels. Whether navigating holiday rushes, in-store events, or day-to-day operations, StaffViz’s flexible scheduling tools keep your team organized and responsive to changing demands.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Learn About Scheduling</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Leverage Actionable Insights to Refine Operations</h2>
                        <h3>
                        Data-Driven Insights and Analytics
                        </h3>
                        <p>Access real-time analytics on team performance, project timelines, and task completion with StaffViz’s dashboard. Analyze comprehensive timesheets, assess resource usage, and uncover productivity trends to enhance efficiency and eliminate bottlenecks in workflows.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Learn About Resource Management</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/dashboard.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="innovative-iteg">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/7488894.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        ...
                        <p>Implement role-based permissions with StaffViz to protect sensitive employee and business data. Customize roles such as Admin, Team Leader, or Retail Associate to limit access and maintain strict confidentiality across your operations.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Merchandise Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-12 m-auto">
                <div class="money_div">
                    <span style="text-transform:uppercase;">Get Started with StaffViz for Merchandising</span>
                    <h2>Elevate Your Retail Efficiency</h2>
                    <p>Empower your merchandising operations with StaffViz. From seamlessly organizing schedules to driving team performance, StaffViz helps you achieve exceptional results and meet the dynamic needs of the retail sector. </p>
