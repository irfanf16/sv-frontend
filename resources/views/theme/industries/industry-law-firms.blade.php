    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Optimize Your Law <br>Firm’s Operations with <br>StaffViz</h1>
                <div class="col-xl-8 col-md-9 hero-text">

                    <p>StaffViz simplifies workforce management, boosts team productivity, and ensures seamless operations for law firms of all sizes.</p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/law-firms.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
...
<!-- Empower Your Team -->
<section id="empower" class="real-estate">
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Efficient Workforce and Task Management</h2>
                        <h6>Effective Case Management and Greater Productivity</h6>
                        <p>Assign tasks, track progress, and ensure alignment across your legal team. StaffViz’s task management tools help law firms operate efficiently, keeping attorneys and staff focused on case priorities while optimizing workflow.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/707490.webp')}}" alt="Img">
            </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Comprehensive Time and Shift Management</h2>
                        <h3>Streamline Staff Schedules for Legal Workloads</h3>
                        <p>Efficiently manage shifts, track attendance, and monitor work hours to prevent understaffing or burnout. Whether handling a high caseload or managing multiple offices, StaffViz’s real-time scheduling tools help you stay agile and responsive.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book a demo</a>
...
<section id="empower" class="resource-mngmnt">
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        ...
                        <h3>
                        Gain Real-Time Visibility into Firm Operations
                        </h3>
                        <p>Leverage detailed reports to track case progress, resource utilization, and employee productivity. StaffViz’s analytics dashboard provides actionable insights, allowing your firm to make informed decisions and improve efficiency.</p>
                    </div>
                    <div class="hero-btns">
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/data-driven.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="innovative-iteg">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/image578.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Advanced Role-Based Security</h2>
                        <h3>
                            Safeguard Confidential Client Information
                        </h3>
                        <p>Control data access with StaffViz’s role-based security settings. Assign permissions for roles such as Partner, Associate, Paralegal, and Administrator to ensure legal information remains protected.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book Demo</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Seamless Compliance and Billing Management</h2>
                        <h3>
                        Maintain Compliance and Simplify Billing
                        </h3>
                        
                        <div class="pb-4">
                            <p>Ensure regulatory compliance and automate billing processes with StaffViz’s integrated solutions. Reduce administrative workload and focus on delivering top-tier legal services.</p>
                            <ul>
                            <li>Generate invoices accurately based on billable hours.</li>
                                <li> Stay aligned with industry regulations and legal standards.</li>
                                
                                <li>Manage firm expenses to maintain financial stability.</li>
                            </ul>
                        </div></div>
                    <div class="hero-btns">
                        <a href="{{url('/integrations')}}"
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/7490002.webp')}}" alt="Img">
            </div>
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Law Firms Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-12 m-auto">
                <div class="money_div"> 
                <h2>Get Started with StaffViz for Law Firms</h2>
                    <span style="text-transform:uppercase;">Elevate Your Legal Practice</span>
                    
                    <p>Streamline operations, enhance efficiency, and improve client service with StaffViz. Experience how our platform empowers legal teams to manage cases effectively and deliver exceptional legal support.</p>
