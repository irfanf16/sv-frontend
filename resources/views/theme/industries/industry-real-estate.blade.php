    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Accurate Time <br>Tracking Made Simple<br> for Real Estate Teams </h1>
                <div class="col-xl-8 col-md-9 hero-text">

                    <p>StaffViz, a cutting-edge tool that saves office staff and real estate professionals important
                        time, streamlines time monitoring and does away with manual logging. </p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/Staffviz-freelance.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Task Management & Scheduling for Real Estate Teams</h2>
                        <h6>Automated Activity & Performance Tracking</h6>
                        <p>Automatically track your team's productivity as soon as they clock in. Review logged
                            activities, replace outdated paper timesheets, and enhance efficiency with StaffViz.
                            Leverage automated reports to make data-driven decisions and boost performance.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/1707489915.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="scalable-infra">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/1707489848.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Customizable Reports for Real Estate Businesses</h2>
                        <h3>Enhance Accuracy in Billing & Payroll</h3>
                        <p>StaffViz ensures precise billing with its time-tracking capabilities. Monitor billable hours,
                            track overtime, and generate customized reports to optimize financial management in your
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        ...
                        <h3>
                            Sync with Real Estate Platforms
                        </h3>
                        <p>Integrate StaffViz with tools you rely on most. From CRM software to task management systems,
                            sync workflows and improve operational efficiency.</p>
                    </div>
                    <div class="hero-btns">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        ...
                        <p>Protect sensitive data related to property transactions, contracts, and client information.
                            StaffViz provides role-based permissions, activity monitoring to ensure confidentiality.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Real Estate Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
