    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Smarter Time<br> Management for<br> Wholesale Businesses </h1>
                <div class="col-xl-8 col-md-9 hero-text">

                    <p>Track, analyze, and optimize your productivity with the best time-tracking software for Wholesale Suppliers. Whether you're running multiple stores or managing online orders, StaffViz offers the tools that help you stay ahead in the competitive wholesale market.</p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/wholesale.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Master Your Schedule with Recurring Tasks</h2>
                        <h6>Simplify Your Daily Workflow</h6>
                        <p>Say goodbye to repetitive reminders. With StaffViz recurring tasks, you can organize anything, from weekly meetings to daily to-do lists. Once you set them up, the system will handle the rest, saving you time and ensuring that your projects are completed on schedule.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/7074898.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="scalable-infra">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/453663.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Move Beyond Manual Timesheets</h2>
                        <h3>Gain Instant Insights into Employee Hours</h3>
                        <p>Take the hassle out of workforce management. Our time and attendance features are the answer for wholesale businesses to simplify time tracking and optimize task scheduling. Save time and reduce errors all in one user-friendly platform.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Optimize Cost Management for Wholesale Suppliers</h2>
                        <h3>
                        Track Billable Hours and Stay Within Budget
                        </h3>
                        <p>Cost control is central to profitability in the wholesale business. Using StaffViz’s Time-tracking feature makes it very easy for suppliers to track labor costs relative to each project or order, so you will have everything needed to stay in control of your budget.</p>
                    </div>
                    <div class="hero-btns">
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/1707490.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="innovative-iteg">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/07490004.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Return Management Perfect Every Step</h2>
                        <h3>
                        Seamless Returns for a Better Experience
                        </h3>
                        <p>Turn returns into a streamlined process with our task assignment feature. Handle refunds and returns effortlessly. By meticulously tracking and logging return-related tasks, you ensure error-free operations—all while creating a hassle-free experience for your customers.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Wholesale Businesses Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 m-auto">
                <div class="money_div">
                    ...
                    <h2>Scale Smarter, Work Faster, and Grow Your Wholesale Business</h2>
                    <p>Optimize your operations, increase efficiency, and stay ahead in the wholesale game. StaffViz is your long-term partner for seamless business management. Let’s build success together!
                    </p>
