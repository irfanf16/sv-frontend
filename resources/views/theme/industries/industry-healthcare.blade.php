    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Easy Time Tracking<br> for Healthcare Teams<br> – Go Paperless </h1>
                <div class="col-xl-8 col-md-9 hero-text">

                    <p>Streamline time tracking by eliminating the need to log hours using manual methods. Use StaffViz, a modern time-tracking solution that saves healthcare workers and administrative staff valuable time.</p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/healthcare.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Tracking & Scheduling Tasks for Healthcare Teams</h2>
                        <h6>Automated Productivity & Activity Tracking</h6>
                        <p>Record your team's productivity automatically once they clock in. Review logged activities, replace outdated paper timesheets with StaffViz to boost overall productivity. Use automated reports to make informed decisions and increase efficiency.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/4363634.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="scalable-infra">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/3456654.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Customize Reports for Healthcare Providers </h2>
                        <h3>Streamline & Improve Billing Accuracy</h3>
                        <p>Staffviz ensures accurate billing with its time-tracking features. Monitor billable hours, track overtime, and generate customized reports to ensure smooth operations in the healthcare industry.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Insights for Healthcare and Administrative Staff</h2>
                        <h3>
                        Optimize Performance with Data-Driven Decisions
                        </h3>
                        <p>Gain real-time access to how administrative staff and healthcare professionals manage their time, enabling you to address inefficiencies and enhance overall performance. With detailed reports and performance metrics to make informed decisions that drive operational excellence and improve patient care.</p>
                    </div>
                    <div class="hero-btns">
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/4564353.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="innovative-iteg">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/3456363.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Healthcare Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12 m-auto">
                <div class="money_div">
                    ...
                    <h2>StaffViz: Your Partner in Modernizing Medical Practice!</h2>
                    <p>Unlock the future of healthcare with StaffViz's innovative time-tracking solutions. Tailored to your medical practice's unique needs, StaffViz drives success in today’s fast-paced world.
                    </p>
