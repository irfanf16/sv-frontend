    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Revolutionize Your <br> Freelance Workflow for <br> Maximum Success </h1>
                <div class="col-xl-8 col-md-9 hero-text">
                    <h3>
                        Elevate your freelance career with StaffViz.
                    </h3>
                    <p>Manage time, tasks, and billing seamlessly while staying productive and organized—all in one
                        platform built for freelancers.</p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/freelance.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Simplify Freelance Workflows</h2>
                        <h6>Centralized Task and Time Management</h6>
                        <div class="pb-4">
                            <p>Keep your projects and tasks perfectly aligned—effortlessly, all in one place. With
                                StaffViz, you can:</p>
                            <ul>
                                <li>Assign and manage tasks across multiple clients.</li>
                                <li>Keep your deadlines on track with live progress updates at your fingertips.</li>
                                <li>Maintain a clear overview of all active projects.</li>
                            </ul>
                            <p>Deliver quality work on time without worrying about administrative overload.</p>
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/1707488.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="scalable-infra freelance">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/1707489.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Tailored Tools for Freelancers</h2>
                        <h3>Flexible Scheduling and Insightful Analytics</h3>
                        <div class="pb-4">
                            <p>Master your time with dynamic scheduling and gain valuable insights into your
                                productivity.
                            </p>
                            <ul>
                                <li>Plan your workday with customizable schedules.</li>
                                <li>Track time spent on individual projects and tasks.</li>
                                <li>Analyze productivity trends to optimize your work habits.</li>
                            </ul>
                            <p>Whether managing multiple clients or balancing work-life commitments, StaffViz adapts to
                                your needs.</p>
                            </p>
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Integrate Seamlessly with Your Favorite Tools</h2>
                        <h3>
                        Streamline Workflows Across Platforms
                        </h3>
                        <div class="pb-4">
                            <p>No more switching between tools. StaffViz integrates with platforms (through Zapier) like Trello, Slack, and Asana to keep your work organized and efficient.
                            </p>
                            <ul>
                                <li>Sync tasks and updates automatically.</li>
                                <li>Reduce manual effort with seamless data sharing.</li>
                            </ul>
                            <p>Simplify your workflow and focus on delivering great results.</p>
                            </p>
                        </div>
                        </div>
                    <div class="hero-btns">
...
<section id="empower" class="innovative-iteg freelance">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/1707489998.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        ...
                        <div class="pb-4">
                            <p>Safeguard sensitive client information and maintain trust with StaffViz’s role based access control feature.
                            </p>
                            <ul>
                                <li>Assign role-based permissions for collaborative projects.</li>
                                <li>Protect data with encryption and activity monitoring.</li>
                                <li>Ensure compliance with client privacy requirements.</li>
                            </ul>
                            <p>Your work deserves protection—and StaffViz has you covered.</p>
                            </p>
                        </div>
                     </div>
                    <div class="hero-btns">
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Freelance Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-12 m-auto">
                <div class="money_div">
                    <span style="text-transform:uppercase;">Get Started with StaffViz</span>
                    <h2>Revolutionize Your Freelance Workflow Today</h2>
                    <p>Forget the stress of manual tracking and scattered tools. StaffViz is your all-in-one solution
                        for managing freelance projects, tracking time, and optimizing operations.
                    </p>
