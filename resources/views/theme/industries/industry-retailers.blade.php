    ...
    <div class="container-fluid">
        <div class="row">
            <div class="hero-head h_t col-xl-8 col-md-10">
                <!-- <h6>Features </h6> -->
                <h1 class="pb-4">Retail Growth?<br> StaffViz Makes It<br> Happen </h1>
                <div class="col-xl-8 col-md-9 hero-text">

                    <p>StaffViz provides the tools to optimize your retail operations, improve productivity, and streamline workforce management, all designed to meet the needs of the retail industry.</p>
            ...
            <div class="col-xl-4 d-none d-xl-block">
                <img class="w-100" src="{{asset('public/assets/img/retailers.webp')}}" alt="Img">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-between align-items-center reverse-me">
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Track Activity & Schedule Tasks for Retail Businesses</h2>
                        <h6>Simplify Time Tracking and Scheduling</h6>
                        <p>StaffViz’s task scheduling feature makes managing tasks easier than ever. From organizing projects to tracking activities, StaffViz empowers retail businesses to save time and optimize labor.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/9shktjkj.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="scalable-infra">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/hdnbz255uk3.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Scalable Operations for Growing Retail Networks</h2>
                        <h3>Expand Your Reach Without Limits</h3>
                        <p>Whether you’re opening new stores, enhancing online channels, or scaling operations, StaffViz grows with your business. Our platform easily adapts so that you can easily scale your retail operations seamlessly.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center reverse-me">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Track Time & Streamline Invoicing</h2>
                        <h3>
                        Calculate Accurate Billable Hours
                        </h3>
                        <p>Allow employees to track billable hours for easier invoicing, set time monitoring targets, and enable overtime alerts. Get insights into your team's performance and prepare for the following retail season.</p>
                    </div>
                    <div class="hero-btns">
            ...
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/b1o8kzq.webp')}}" alt="Img">
            </div>
...
<section id="empower" class="innovative-iteg">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-7 col-md-12 break-img">
                <img class="w-100" src="{{asset('public/assets/img/lygbo1q721.webp')}}" alt="Img">
            </div>
            <div class="col-lg-5 col-md-12">
                <div class="inner-contents">
                    <div class="all-text">
                        <h2>Retail Shift Scheduling and Timesheets</h2>
                        <h3>
                        Track Attendance & Employee’s Performance
                        </h3>
                        <p>See who’s available, organize shifts, and save shift templates for easy adjustments. Keep an eye on employee attendance, hours worked, breaks, overtime, and time off all-in-one reports.</p>
                    </div>
                    <div class="hero-btns">
                        <a href="https://api.streamlinerei.com/widget/booking/Yfp2VXl8NMqVzIjrqAXp"
                            class="demo contact_btn">Book A Demo</a>
...
<section id="key-features">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h2>
                    Key Features to Maximize Efficiency in the Retailers Industry with StaffViz
                </h2>
            </div>
        </div>
        <div class="row justify-content-center">
