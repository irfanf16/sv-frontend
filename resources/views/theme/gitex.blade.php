...
<body class="index-page">
    ...
    <!-- Gitex Banner Starts -->
    <section class="itcn-banner gitex-banner">
        <header>
        ...
        <div class="container-fluid">
            <div class="stick-left-text">
                <div class="white-bg">
                    <h5>GITEX 2024 - October 13th - 16th</h5>
                </div>
                <div class="black-bg">
            ...
            <div class="row">
                <div class="col-12 main-text text-center">
                    <h1>Improve your team's productivity & performance</h1>
                    <h2>World’s #1 Workforce Analytics Platform</h2>
                    <p>Maximize Organizational Productivity and Management While Maintaining Top-Tier Performance</p>
                    <div class="links d-md-flex align-items-center justify-content-center">
                        <a href="https://outlook.office365.com/owa/calendar/StaffVizProductService@crecentech.com/bookings/" target="_blank">
                            SCHEDULE A CALL
                        </a>
                        <a href="{{url('/')}}/gitex-contact-us">
                            CONTACT US
                        </a>
                        <a href="<?= asset('public/assets/pdf/product-profile.pdf'); ?>">Product Profile</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="track-second-section gitex-track-second-section">
    ...
    <!-- Get A Pass Section -->
    <section class="get-a-pass-section gitex-get-a-pass-section">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-8 text">
                    <h2>Get a Pass, and Don’t Miss<br> StaffViz at GITEX 2024</h2>
                </div>
    ...
    <section class="gitex-door-to-track-section door-to-track-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 text-center start-text">
    ...
    <section class="gitex-meet-staffiz-section meet-staffiz-section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 start-text text-center">
                    <h2><span>Meet StaffViz</span> at GITEX 2024</h2>
    ...
    <section class="gitex-lets-meet-at lets-meet-at">
        <div class="container">
            <div class="row">
                <div class="col-12 text text-center">
                    <h2>Participate in GITEX 2024</h3>
                        <span class="lets-meet-at-text">
                            Let's Meet at
                        </span>
                        <img src="{{ asset('public/assets/itcn-images/gitex-logo.webp') }}" alt="Logo">
                </div>
            </div>
        </div>
    </section>
