$(document).ready(function () {
    ...
    function loadStepsData() {
        ...
        // parameters values
        company_type = localStorageData.company_type ? localStorageData.company_type : "ancr";
        ...
        data_company_id = localStorageData.data_company_id
            ...
            if( localStorageData.hide_card_details == true){
                ...
                $('.countChange').text('4. Setup Successful')
        ...
        (async () => {
             if (parentID == "personal-details") {
                ...
                if( formation_type=='direct'){
                    ...
                    var companyName = $("#company-name").val();
                    company_name=companyName; //assgine new value
                }
    ...
    $(document).on("keyup keydown keypress copy paste cut", "#company_email_talk,#first_name_talk,#company_name_talk,#msg", function (e) {
        var flag = 1;
    ...
    async function paymentConfirmFromOldCard(
        card_id,
        enc_data,
    ) {
        try {
    ...
    async function talkToSales(email,
        firstName,
        noOfEmployees,
        companyName,
        phone,
